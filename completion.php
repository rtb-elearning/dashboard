...
/**
 * RTB Dashboard completion report page.
 *
...
$PAGE->set_url(new moodle_url('/local/rtbdashboard/completion.php'));
$PAGE->set_pagelayout('standard');
$PAGE->set_title(get_string('page_title', 'local_rtbdashboard') . ' - Completion Report');
...
$PAGE->add_body_class('local-rtbdashboard-completion');
...
$PAGE->navbar->add(get_string('pluginname', 'local_rtbdashboard'), new moodle_url('/local/rtbdashboard/index.php'));
